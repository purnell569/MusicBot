 ...
 *
 * Modified 2026: added the YouTube remote cipher config options.
 *
...
public enum ConfigOption {
    ...
    YOUTUBE_REMOTE_CIPHER_URL("playback.youtube.remoteCipher.url", ConfigType.STRING, false, "Remote cipher server used to decipher YouTube stream signatures (empty to use the local extractor)"),
    YOUTUBE_REMOTE_CIPHER_PASSWORD("playback.youtube.remoteCipher.password", ConfigType.STRING, false, "Password for the remote cipher server, if it requires one"),
